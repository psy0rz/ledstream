...
#if defined(CONFIG_LEDSTREAM_COLOR_ORDER_RGB)
#define COLOR_ORDER RGB
#elif defined(CONFIG_LEDSTREAM_COLOR_ORDER_RBG)
#define COLOR_ORDER RBG
#elif defined(CONFIG_LEDSTREAM_COLOR_ORDER_GBR)
#define COLOR_ORDER GBR
#elif defined(CONFIG_LEDSTREAM_COLOR_ORDER_BRG)
#define COLOR_ORDER BRG
#elif defined(CONFIG_LEDSTREAM_COLOR_ORDER_BGR)
